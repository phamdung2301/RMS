...
public interface BranchInventoryRepository extends JpaRepository<BranchInventory, Long> {
    List<BranchInventory> findByBranchBranchId(String branchId);
    Optional<BranchInventory> findByBranchBranchIdAndItemSku(String branchId, String sku);
    Optional<BranchInventory> findByBranchBranchIdAndItemId(String branchId, Long itemId);
}
