...
@Entity
@Table(name = "forgot_clock_requests")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ForgotClockRequest {
    @Id
    ...
    @Column(name = "time_proposed", nullable = false)
    private String timeProposed; // e.g. "08:05"

    @Column(name = "clock_type", nullable = false)
    private String clockType; // CLOCK_IN, CLOCK_OUT
